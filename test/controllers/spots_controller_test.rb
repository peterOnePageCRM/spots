...
class SpotsControllerTest < ActionController::TestCase
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post :create, spot: { description: @spot.description, location: @spot.location, title: @spot.title }
    end
  ...
  test "should update spot" do
    patch :update, id: @spot, spot: { description: @spot.description, location: @spot.location, title: @spot.title }
    assert_redirected_to spot_path(assigns(:spot))
  end
